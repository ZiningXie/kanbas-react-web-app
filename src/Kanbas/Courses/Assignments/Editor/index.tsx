...
function AssignmentEditor() {
  ...
  return (
    <div className="flex-fill">
      ...
      <div className="mb-3 row">
        <label htmlFor="points" className="form-label col-sm-2">
          Points
        </label>
      ...
      <div className="mb-3 row">
        <label htmlFor="assignmentGroup" className="form-label col-sm-2">
          Assignment Group
        </label>
        <div className="col-md-4">
      ...
      <div className="mb-3 row align-items-center">
        <label htmlFor="displayGradeAs" className="form-label col-sm-2">
          Display Grade as
        </label>
        <div className="col-md-4">
      ...
      <div className="mb-3">
        ...
        />
        <label className="form-check-label" htmlFor="checkboc">
